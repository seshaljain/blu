...
** DONE Find common elements in 3 sorted arrays :array:@done:
...
** DONE Search in a rotated sorted array :search_sort:@done:
...
** DONE Intersection point of two linked lists :ll:@done:
CLOSED: [2021-07-20 Tue]
:PROPERTIES:
...
** DONE Check if a tree is balanced :bt:@done:
CLOSED: [2021-07-20 Tue]
:PROPERTIES:
...
** DONE Find LCA in a binary tree :bt:@done:
CLOSED: [2021-07-18 Sun]
:PROPERTIES:
...
** DONE Find LCA in a BST :bst:@done:
CLOSED: [2021-07-18 Sun]
:PROPERTIES:
...
** DONE Find minimum number of coins :greedy:@done:
CLOSED: [2021-07-17 Sat]
:PROPERTIES:
...
** DONE Connect N ropes with minimum cost :heap:greedy:@done:
CLOSED: [2021-07-18 Sun]
:PROPERTIES:
...
** DONE Minimum steps by knight :graph:@done:
CLOSED: [2021-07-17 Sat]
:PROPERTIES:
...
** DONE Minimum time taken by each job to be completed given by a directed acyclic graph :graph:
CLOSED: [2021-07-18 Sun]
:PROPERTIES:
