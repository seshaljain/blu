...
** TODO Find the maximum and minimum element in an array :array:@done:
...
** TODO Find the Kth max and min element in an array :array:heap:@done:
CLOSED: [2021-06-16 Wed]
:PROPERTIES:
...
** TODO Move all the negative elements to one side of the array :@done:array:
:PROPERTIES:
...
** TODO Find the union and intersection of the two sorted arrays :array:@done:
...
** TODO Cyclically rotate an array by one :@done:array:
:PROPERTIES:
...
** TODO [#A] Minimise the maximum difference between heights :@done:array:
:PROPERTIES:
...
** TODO Minimum number of jumps to reach end of an array :@done:array:
:PROPERTIES:
...
** TODO Find the duplicate in an array of N+1 integers :@done:array:
:PROPERTIES:
...
** TODO Merge intervals :array:@done:
CLOSED: [2021-06-20 Sun]
:PROPERTIES:
...
** TODO Count inversion :array:search_sort:@done:
...
** TODO [#A] Best time to buy and sell stock :@done:array:
:PROPERTIES:
...
** TODO Find all pairs on integer array whose sum is equal to K :array:@done:
CLOSED: [2021-06-20 Sun]
:PROPERTIES:
...
** TODO Find common elements in 3 sorted arrays :array:@done:
CLOSED: [2021-07-17 Sat]
:PROPERTIES:
...
** TODO Given an array of size N and a number K, find all elements that appear more than N/K times :array:@done:
...
** TODO Find whether an array is a subset of another array :array:@done:
...
** TODO Find the triplet that sum to a given value :array:@done:
CLOSED: [2021-06-24 Thu]
:PROPERTIES:
...
** TODO Trapping rain water :@done:array:
:PROPERTIES:
...
** TODO Chocolate distribution :@done:array:greedy:
:PROPERTIES:
...
** TODO Minimum number of merge operations required to make an array palindrome :array:@done:
CLOSED: [2021-06-24 Thu]
:PROPERTIES:
...
** TODO Search an element in a matrix :@done:matrix:
:PROPERTIES:
...
** TODO Check whether a string is palindrome :@done:string:
:PROPERTIES:
...
** TODO Find duplicate characters in a string :string:@done:
:PROPERTIES:
...
** TODO Why are strings immutable in Java? :@done:string:
:PROPERTIES:
...
** TODO Check whether one string is a rotation of another :@done:string:
:PROPERTIES:
...
** TODO Check whether a string is a valid shuffle of two strings :@done:string:
:PROPERTIES:
...
** TODO Count and say :@done:string:
:PROPERTIES:
...
** TODO Find the longest palindrome in a string :string:@done:
:PROPERTIES:
...
** TODO Split the binary string into two substring with equal 0s and 1s :string:@done:
CLOSED: [2021-06-17 Thu]
:PROPERTIES:
...
** TODO [#A] Edit distance :string:dp:@done:
CLOSED: [2021-06-17 Thu]
:PROPERTIES:
...
** TODO Convert a sentence into its equivalent mobile numeric keypad sequence :string:@done:
:PROPERTIES:
...
** TODO Minimum number of bracket reversals needed to make an expression balanced :@done:string:
:PROPERTIES:
...
** TODO Count of number of given string in 2D character array :string:@done:
...
** TODO Longest common prefix :string:@done:
:PROPERTIES:
...
** TODO Number of flips to make binary string alternate :@done:string:
:PROPERTIES:
...
** TODO Find the second most repeated word in string :@done:string:
:PROPERTIES:
...
** TODO Recursively remove all adjacent duplicates :@done:string:
:PROPERTIES:
...
** TODO Transform one string to another using minimum number of given operation :string:@done:
CLOSED: [2021-06-17 Thu]
:PROPERTIES:
...
** TODO Find a fixed point (value equal to index) in a given array :search_sort:@done:
CLOSED: [2021-06-20 Sun]
:PROPERTIES:
...
** TODO Search in a rotated sorted array :search_sort:@done:
CLOSED: [2021-07-20 Tue]
:PROPERTIES:
...
** TODO Find missing and repeating :@done:search_sort:
:PROPERTIES:
...
** TODO Searching in an array where adjacent differ by at most K :@done:search_sort:
:PROPERTIES:
...
** TODO Merge 2 sorted arrays :@done:array:search_sort:
:PROPERTIES:
...
** TODO Sort array according to count of set bits :@done:search_sort:
:PROPERTIES:
...
** TODO Kth smallest number again :@done:search_sort:
:PROPERTIES:
...
** TODO Book allocation aka Painter's Partition :@done:search_sort:
:PROPERTIES:
...
** TODO Reverse a linked list in group of given size :ll:@done:
...
** DONE Add two numbers represented by linked lists :ll:@done:
CLOSED: [2022-06-23 Thu]
:PROPERTIES:
...
** TODO Intersection of two sorted linked list :ll:@done:
...
** TODO Intersection point of two linked lists :ll:@done:
CLOSED: [2021-07-20 Tue]
:PROPERTIES:
...
** TODO Reverse a doubly linked list :ll:@done:
...
** TODO Why is quicksort preferred for arrays while merge sort for linked lists? :ll:@done:
CLOSED: [2021-06-23 Wed]
:PROPERTIES:
...
** TODO Flatten a linked list :ll:@done:
CLOSED: [2021-07-14 Wed]
:PROPERTIES:
...
** TODO Clone a linked list with next and random pointer :ll:@done:
CLOSED: [2021-07-14 Wed]
:PROPERTIES:
...
** HOLD Inorder traversal of a tree :@done:bt:
:PROPERTIES:
...
** HOLD Preorder traversal of a tree :@done:bt:
:PROPERTIES:
...
** HOLD Postorder traversal of a tree :@done:bt:
:PROPERTIES:
...
** DONE Right view of a tree :bt:@done:
CLOSED: [2022-06-24 Fri]
:PROPERTIES:
...
** TODO Check if a tree is balanced :bt:@done:
CLOSED: [2021-07-20 Tue]
:PROPERTIES:
...
** TODO Find LCA in a binary tree :bt:@done:
CLOSED: [2021-07-18 Sun]
:PROPERTIES:
...
** DONE Find a value in a BST :bst:@done:
CLOSED: [2022-06-28 Tue]
:PROPERTIES:
...
** DONE Find min and max value in a BST :bst:@done:
CLOSED: [2022-06-28 Tue]
:PROPERTIES:
...
** DONE Check if a tree is a BST :bst:@done:
CLOSED: [2022-06-28 Tue]
:PROPERTIES:
...
** TODO Find LCA in a BST :bst:@done:
CLOSED: [2021-07-18 Sun]
:PROPERTIES:
...
** TODO Fractional knapsack :@done:greedy:
:PROPERTIES:
...
** TODO Find minimum number of coins :greedy:@done:
CLOSED: [2021-07-17 Sat]
:PROPERTIES:
...
** TODO Implement stack from scratch :@done:st_q:
:PROPERTIES:
...
** TODO Implement queue from scratch :@done:st_q:
:PROPERTIES:
...
** TODO Implement 2 stack in an array :@done:st_q:
:PROPERTIES:
...
** TODO Reverse a string using stack :st_q:@done:
...
** TODO Implement a maxheap/minheap :heap:@done:
...
** TODO [#A] Merge K sorted arrays :heap:@done:
:PROPERTIES:
...
** TODO Connect N ropes with minimum cost :heap:greedy:@done:
CLOSED: [2021-07-18 Sun]
:PROPERTIES:
...
** TODO Detect cycle in directed graph using BFS/DFS :graph:@done:
...
** TODO Detect cycle in undirected graph using BFS/DFS :graph:@done:
...
** TODO Minimum steps by knight :graph:@done:
CLOSED: [2021-07-17 Sat]
:PROPERTIES:
...
** TODO Implement topological sort :graph:@done:
...
** TODO Check if graph is bipartite :graph:@done:
...
** TODO Painting the fence :dp:@done:
CLOSED: [2021-07-14 Wed]
:PROPERTIES:
...
** TODO Maximize the cut segments :@done:dp:
:PROPERTIES:
...
** TODO Longest common subsequence :@done:string:dp:
:PROPERTIES:
...
** TODO Longest repeated subsequence :@done:string:dp:
:PROPERTIES:
...
** TODO Longest increasing subsequence :dp:@done:
CLOSED: [2021-07-15 Thu]
:PROPERTIES:
...
** TODO Longest common substring :@done:dp:
:PROPERTIES:
...
** TODO Unbounded knapsack :@done:dp:
:PROPERTIES:
...
** TODO Longest palindromic subsequence :@done:dp:
:PROPERTIES:
...
** TODO Count set bits in an integer :@done:bit:
:PROPERTIES:
